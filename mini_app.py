...
def take_img():
    ...
    if enrollment == '' or name == '':
        ...
        detector = cv2.CascadeClassifier(r'c:\Users\Dhanush Goud\Downloads\AICTE_Internship_Smart_Attendance-master\AICTE_Internship_Smart_Attendance-master\haarcascade_frontalface_default.xml')
