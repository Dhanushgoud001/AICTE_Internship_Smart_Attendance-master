...
class AttendanceSystem:
    def __init__(self, window):
        ...
        self.detector = cv2.CascadeClassifier(r'C:\Users\Dhanush Goud\Downloads\AICTE_Internship_Smart_Attendance-master\AICTE_Internship_Smart_Attendance-master\haarcascade_frontalface_default.xml')
        self.cap = None
